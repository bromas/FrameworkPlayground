//
//  NavigationControllerTransitionParticipatior.swift
...
extension UINavigationController : TransitionParticipant {
  
  var prepareForAppearingAnimation : () -> Void {
    get {
      let controller = self.topViewController as? TransitionParticipant
